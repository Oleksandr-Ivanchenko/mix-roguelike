...
export class EnemySystem {
  ...
  _pickType() {
    ...
    if      (s.level >= 8  && roll < 0.05) return "boss";
    else if (s.level >= 7  && roll < 0.10) return "abomination";
    else if (s.level >= 6  && roll < 0.16) return "harvester";
    else if (s.level >= 5  && roll < 0.23) return "knight";
    else if (s.level >= 5  && roll < 0.30) return "flanker";
    else if (s.level >= 4  && roll < 0.38) return "shooter";
    else if (s.level >= 4  && roll < 0.46) return "sentinel";
    else if (s.level >= 3  && roll < 0.55) return "tank";
    else if (s.level >= 3  && roll < 0.63) return "marauder";
    else if (s.level >= 2  && roll < 0.74) return "fast";
    else if (wave  >= 2    && roll < 0.83) return "flanker";
    return "basic";
  }
